...
Character.create(
    user_id: stanley.id, 
    tribe_id: druids.id, 
    character_name: "cratum", 
    status: "peasant", 
    weapon: "http://flyff-wiki.webzen.com/images/0/04/Angels_Sword.png", 
    avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyKAbEHNaAP6Iawo470QXix-miB6iA9ufV39Rj7t3ufYj1ujKH")
